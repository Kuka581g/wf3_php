...
echo "<h2 style=\" font-size: 2.5em; border: 1px solid; width: 48%; box-shadow: 2px 4px 2px grey; margin: auto; padding: 14px; text-shadow: 1px 0px 1px; \">$nom_pokemon1 affronte $nom_pokemon2</h2>";
